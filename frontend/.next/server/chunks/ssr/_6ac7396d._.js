...
"[project]/hooks/useRecommendUser.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useUsers() {
    ...
    const { friends } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFriend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFriend"])();
    const [users, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    // ✅ Fetch recommended users
    const fetchRecommendedUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRecommendedUsers"])();
            // ✅ Filter logic moved to hook
            const filteredUsers = (data || []).filter((u)=>u._id !== user?._id && !friends.some((f)=>f._id === u._id));
            setUsers(filteredUsers);
            console.log('✅ Recommended users loaded:', filteredUsers.length);
        } catch (err) {
            console.error('❌ Failed to fetch recommended users:', err);
            setError(err.message || 'Failed to load recommended users');
            setUsers([]);
        } finally{
            setLoading(false);
        }
    ...
    const handleSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (query)=>{
        ...
        try {
            setLoading(true);
            setError(null);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["searchUsers"])(query);
            ...
            if (err.message.includes('401') || err.message.includes('Unauthorized')) {
                ...
                // Note: Router push should be handled in component
    ...
    return {
        ...
        error,
        handleSearch,
        refreshRecommended: fetchRecommendedUsers
    };
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useRecommendUser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useRecommendUser.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFriend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useFriend.ts [app-ssr] (ecmascript)");
'use client';
;
;
...
function AddFriendsPage() {
    ...
    const { users, loading, error, handleSearch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useRecommendUser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUsers"])();
    const { sendFriendRequest } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFriend$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFriend"])();
    ...
    const handleSendRequest = async (userId)=>{
        try {
            ...
            // Optional: Remove user from list or show success message
            }
        } catch (error) {
            console.error('❌ Error sending friend request:', error);
        } finally{
                        ...
                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    ...
                                    children: searchQuery ? `Search Results (${users.length})` : `Recommended Users (${users.length})`
                                }, void 0, false, {
                                    fileName: "[project]/app/(protected)/(dashBoard)/friends/add/page.tsx",
                                    lineNumber: 116,
                                    columnNumber: 29
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    ...
                                    children: searchQuery ? 'No users found' : 'No users available'
                                }, void 0, false, {
                                    fileName: "[project]/app/(protected)/(dashBoard)/friends/add/page.tsx",
                                    lineNumber: 135,
                                    columnNumber: 29
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-gray-400",
                                    children: searchQuery ? 'Try adjusting your search terms' : 'No recommended users at the moment'
                                }, void 0, false, {
                                    fileName: "[project]/app/(protected)/(dashBoard)/friends/add/page.tsx",
                                    lineNumber: 138,
                                    columnNumber: 29
...
// ✅ User Card Component (same as before)
...
//# sourceMappingURL=_6ac7396d._.js.map