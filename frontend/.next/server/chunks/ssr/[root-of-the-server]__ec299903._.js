...
const makeAuthenticationRequest = async (endpoint, options = {})=>{
    ...
    let token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tokenUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthToken"])() || localStorage.getItem('auth_token');
...
function AuthProvider({ children }) {
    ...
    const logout = async ()=>{
        ...
        try {
            // Clear local storage
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tokenUtils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["removeAuthToken"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec299903._.js.map