...
const signup = async (signupData)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post("/auth/sign-up", signupData);
...
const login = async (loginData)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post("/auth/login", loginData);
        return response.data;
    } catch (error) {
        return {
            success: false,
...
const logout = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post("/auth/logout");
    return response.data;
};
...
async function getUserFriends() {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].get("/users/friends");
    return response.data;
}
async function getRecommendedUsers() {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].get("/users");
    return response.data;
}
async function getOutgoingFriendReqs() {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].get("/users/outgoing-friend-requests");
    return response.data;
}
async function sendFriendRequest(userId) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].post(`/users/friend-request/${userId}`);
    return response.data;
}
async function getFriendRequests() {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].get("/users/friend-requests");
    return response.data;
}
async function acceptFriendRequest(requestId) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].put(`/users/friend-request/${requestId}/accept`);
    return response.data;
}
async function getStreamToken() {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].get("/chat/token");
    return response.data;
}
}}),
"[project]/hooks/useAuthUser.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const useAuthUser = ()=>{
    const authUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "authUser"
        ],
...
"[project]/app/(protected)/layout.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProtectedLayout({ children }) {
    ...
    const { isLoading, authUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuthUser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__39d15ab7._.js.map