...
const apiClient = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: BASE_URL,
    timeout: 10000,
    headers: {
    ...
    providers: [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                try {
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authAPI"].signIn({
        ...
        async signIn ({ user, account, profile }) {
            ...
            if (account?.provider === "google") {
                try {
                    ...
                    const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5001/api")}/auth/oauth`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json"
                        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__87a0376b._.js.map