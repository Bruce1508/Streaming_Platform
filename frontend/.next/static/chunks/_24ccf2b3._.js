...
function NextAuthSessionProvider({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ // Refetch session mỗi 5 phút thay vì liên tục
    ["SessionProvider"], {
...
"[project]/app/hydration-fix.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>HydrationFix)
});
...
function HydrationFix() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HydrationFix.useEffect": ()=>{
            ...
            // List of browser extension attributes that cause hydration warnings
            ...
            const isExtensionHydrationError = {
                "HydrationFix.useEffect.isExtensionHydrationError": (message)=>{
                    // Check for hydration mismatch messages
                    ...
                    const isHydrationError = hydrationKeywords.some({
                        "HydrationFix.useEffect.isExtensionHydrationError.isHydrationError": (keyword)=>message.includes(keyword)
                    }["HydrationFix.useEffect.isExtensionHydrationError.isHydrationError"]);
                    if (!isHydrationError) {
                        return false;
                    }
                    // Check if it mentions browser extensions or known extension attributes
                    ...
                    return extensionKeywords.some({
                        "HydrationFix.useEffect.isExtensionHydrationError": (attr)=>message.includes(attr)
                    }["HydrationFix.useEffect.isExtensionHydrationError"]);
                }
            }["HydrationFix.useEffect.isExtensionHydrationError"];
            // Override console.error
            console.error = ({
                "HydrationFix.useEffect": (...args)=>{
                    const message = args.join(' ');
                    if (isExtensionHydrationError(message)) {
                        // Optionally log a simplified debug message
                        console.debug('🔇 Suppressed hydration warning from browser extension');
                        return;
                    }
...
_s(HydrationFix, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = HydrationFix;
var _c;
...
//# sourceMappingURL=_24ccf2b3._.js.map