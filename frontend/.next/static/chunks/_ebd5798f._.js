...
"[project]/lib/UploadApi.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const BASE_URL = ("TURBOPACK compile-time value", "http://localhost:5001/api") || 'http://localhost:5000/api';
...
_s(uploadFile, "VFxct4SzMpAPlFX99BNTgx+1HA8=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$UploadApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/UploadApi.ts [app-client] (ecmascript)");
...
function useUpload() {
    ...
    const addFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUpload.useCallback[addFiles]": (newFiles)=>{
            const filesWithPreview = newFiles.map({
                "useUpload.useCallback[addFiles].filesWithPreview": (file)=>{
                    const info = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFileInfo"])(file);
                    const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateFile"])(file);
            ...
            }["useUpload.useCallback[addFiles].filesWithPreview"]);
            setState({
    ...
    const removeFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUpload.useCallback[removeFile]": (fileId)=>{
            setState({
                "useUpload.useCallback[removeFile]": (prev)=>{
                    const updatedFiles = prev.files.filter({
                        "useUpload.useCallback[removeFile].updatedFiles": (f)=>f.id !== fileId
                    }["useUpload.useCallback[removeFile].updatedFiles"]);
                    // Clean up preview URLs
                    const removedFile = prev.files.find({
                        "useUpload.useCallback[removeFile].removedFile": (f)=>f.id === fileId
                    }["useUpload.useCallback[removeFile].removedFile"]);
    ...
    const uploadSingleFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUpload.useCallback[uploadSingleFile]": async (fileWithPreview)=>{
            if (!user) {
                throw new Error('Authentication required');
            }
            ...
            setState({
                "useUpload.useCallback[uploadSingleFile]": (prev)=>({
                        ...prev,
                        uploading: true,
                        progress: 0,
                        error: null
            ...
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$UploadApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadFile"])(fileWithPreview.file, {
                    "useUpload.useCallback[uploadSingleFile]": (progress)=>{
                        setState({
                            "useUpload.useCallback[uploadSingleFile]": (prev)=>({
                                    ...prev,
                                    progress
    ...
    const uploadAllFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUpload.useCallback[uploadAllFiles]": async ()=>{
            const validFiles = state.files.filter({
                "useUpload.useCallback[uploadAllFiles].validFiles": (f)=>f.validation.isValid
            }["useUpload.useCallback[uploadAllFiles].validFiles"]);
            if (validFiles.length === 0) {
                setState({
                    "useUpload.useCallback[uploadAllFiles]": (prev)=>({
                            ...prev,
            ...
            setState({
                "useUpload.useCallback[uploadAllFiles]": (prev)=>({
                        ...
                        files: prev.files.filter({
                            "useUpload.useCallback[uploadAllFiles]": (f)=>!f.validation.isValid
                        }["useUpload.useCallback[uploadAllFiles]"])
                    })
            }["useUpload.useCallback[uploadAllFiles]"]);
            return results;
    ...
    const deleteUploadedFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUpload.useCallback[deleteUploadedFile]": async (filename)=>{
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$UploadApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteFile"])(filename);
                setState({
                    "useUpload.useCallback[deleteUploadedFile]": (prev)=>({
                            ...prev,
                            uploadedFiles: prev.uploadedFiles.filter({
                                "useUpload.useCallback[deleteUploadedFile]": (file)=>file?.attachment.filename !== filename
                            }["useUpload.useCallback[deleteUploadedFile]"])
                        })
                }["useUpload.useCallback[deleteUploadedFile]"]);
            } catch (error) {
    ...
    const reset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUpload.useCallback[reset]": ()=>{
            // Clean up preview URLs
            state.files.forEach({
                "useUpload.useCallback[reset]": (file)=>{
                    if (file.preview) {
    ...
    const getStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useUpload.useCallback[getStats]": ()=>{
            const validFiles = state.files.filter({
                "useUpload.useCallback[getStats].validFiles": (f)=>f.validation.isValid
            }["useUpload.useCallback[getStats].validFiles"]);
            const invalidFiles = state.files.filter({
                "useUpload.useCallback[getStats].invalidFiles": (f)=>!f.validation.isValid
            }["useUpload.useCallback[getStats].invalidFiles"]);
            const totalSize = state.files.reduce({
                "useUpload.useCallback[getStats].totalSize": (sum, f)=>sum + f.info.size
            ...
            return {
                ...
                totalSize,
                totalSizeFormatted: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatFileSize"])(totalSize),
    ...
    return {
        ...
        getStats,
        // Validation
        validateFile: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateFile"],
        formatFileSize: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatFileSize"]
    };
}
_s(useUpload, "5n1YMD5jZs8YWbHzKYXlA1Z2D/Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/components/ui/FilePreview.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function FilePreview({ file, onRemove, className, showRemoveButton = true }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('relative group border rounded-lg p-4 bg-white shadow-sm hover:shadow-md transition-shadow', file.validation.isValid ? 'border-gray-200' : 'border-red-200 bg-red-50', className),
        children: [
            showRemoveButton && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: file.info.category === 'image' && file.preview ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    file.validation.error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('inline-flex items-center px-2 py-1 rounded-full text-xs font-medium', file.info.category === 'image' && 'bg-blue-100 text-blue-800', file.info.category === 'pdf' && 'bg-red-100 text-red-800', file.info.category === 'document' && 'bg-gray-100 text-gray-800'),
...
function FilePreviewGrid({ files, onRemove, className }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4', className),
        children: files.map((file)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FilePreview, {
                file: file,
                onRemove: onRemove
            }, file.id, false, {
                fileName: "[project]/components/ui/FilePreview.tsx",
...
__turbopack_context__.k.register(_c1, "FilePreviewGrid");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$FilePreview$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/FilePreview.tsx [app-client] (ecmascript)");
        ...
        children: [
            ...
            uploadStep === 'preview' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$FilePreview$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FilePreviewGrid"], {
                        files: files,
                        onRemove: removeFile
                    }, void 0, false, {
                        fileName: "[project]/components/ui/FileUpload.tsx",
...
//# sourceMappingURL=_ebd5798f._.js.map