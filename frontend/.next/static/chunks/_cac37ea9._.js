...
async function cancelFriendRequest(recipientId) {
    try {
        const response = await makeAuthenticationRequest(`/users/friend-request/${recipientId}/cancle`, {
            method: 'DELETE'
        });
        if (!response.ok) {
            const errorData = await response.json();
...
function HomePage() {
    ...
    const [cancellingRequest, setCancellingRequest] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Fetch friends
    ...
    const handleCancelFriendRequest = async (userId)=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelFriendRequest"])(userId);
            // Refresh outgoing requests to update UI
            await fetchOutgoingRequests();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Friend request cancelled!');
        } catch (error) {
            console.error('Error cancelling friend request:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Failed to cancel friend request');
        } finally{
...
_s(HomePage, "2yvjjZM8SXWllSWzKgbwpF7Qh2E=", false, function() {
    return [
...
"[project]/node_modules/lucide-react/dist/esm/icons/circle-check-big.js [app-client] (ecmascript) <export default as CheckCircleIcon>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "CheckCircleIcon": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])
});
...
//# sourceMappingURL=_cac37ea9._.js.map