    ...
    const { data, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "TestPage.useQuery": async ()=>{
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosInstance$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].get("https://localhost:5001/api/auth/me");
                return res.data;
            }
        }["TestPage.useQuery"],
        retry: false
...
//# sourceMappingURL=_99eb0587._.js.map