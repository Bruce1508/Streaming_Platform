...
"[project]/node_modules/stream-chat/dist/esm/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var cookies_default = browser_default.isStandardBrowserEnv ? // Standard browser envs support document.cookie
...
var isURLSameOrigin_default = browser_default.isStandardBrowserEnv ? // Standard browser envs have full support of the APIs needed to test
...
var MiddlewareExecutor = class {
    ...
    async executeMiddlewareChain({ eventName, initialValue }) {
        let index = -1;
...
var createPollComposerStateMiddleware = ({ processors: customProcessors, validators: customValidators } = {})=>{
    const universalHandler = ({ state, validators: validators3, processors })=>{
...
var initState4 = ({ composer, message })=>{
    if (!message) {
...
var _MessageComposer = class _MessageComposer extends WithSubscriptions {
    ...
    constructor({ composition, config, compositionContext, client }){
        ...
        this.subscribeDraftUpdated = ()=>this.client.on("draft.updated", (event)=>{
                ...
                if (!draft || !!draft.parent_id !== !!this.threadId || draft.channel_cid !== this.channel.cid) return;
                this.initState({
                    composition: draft
                });
            }).unsubscribe;
...
var Channel = class {
   ...
   */ async query(options = {}, messageSetToAddToIfDoesNotExist = "current") {
        ...
        if (state.draft) {
            this.messageComposer.initState({
                composition: state.draft
            });
        }
        const areCapabilitiesChanged = [
...
var StreamChat = class _StreamChat {
     ...
     */ this.createChannelManager = ({ eventHandlerOverrides = {}, options = {} })=>new ChannelManager({
                client: this,
    ...
    hydrateActiveChannels(channelsFromApi = [], stateOptions = {}, queryChannelsOptions) {
        ...
        for (const channelState of channelsFromApi){
            ...
            if (channelState.draft) {
                c.messageComposer.initState({
                    composition: channelState.draft
                });
            }
            channels.push(c);
        }
...
//# sourceMappingURL=node_modules_stream-chat_dist_esm_index_7dbda111.js.map