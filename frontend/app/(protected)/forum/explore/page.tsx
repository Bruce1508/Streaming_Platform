...
// ===== EXPLORE PAGE =====
// Trang khám phá tất cả posts từ tất cả schools
const ExplorePage = () => {
    ...
    const fetchPosts = async (isLoadMore = false) => {
        try {
            ...
            if (response && response.posts) {
                ...
                console.log('✅ Explore posts loaded:', newPosts.length);
                ...
                console.log('✅ Explore posts loaded (alt structure):', newPosts.length);
            } else {
            ...
            console.error('❌ Fetch explore posts error:', error);
            if (!isLoadMore) setPosts([]);
    ...
    const lastPostRef = useCallback((node: HTMLDivElement) => {
        ...
        observerRef.current = new IntersectionObserver(entries => {
            if (entries[0].isIntersecting && hasMore && !isLoadingMore) {
                console.log('🔄 Loading more explore posts...');
                fetchPosts(true);
            }
        }, {
            threshold: 0.1,
