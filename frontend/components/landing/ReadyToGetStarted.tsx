...
export default function ReadyToGetStarted() {
    return (
        <section className="pt-30 pb-30 bg-[#FAF9F6] w-full">
                ...
                <div className="flex flex-col lg:flex-row items-start justify-between gap-16">
                    ...
                    <div className="flex-1 max-w-lg">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link href="/contact">
                                <Button variant="ghost" className="text-red-600 hover:text-red-700 font-semibold px-6 py-3 transition-colors">
                                    Contact Us →
                                </Button>
                            </Link>
                        </div>
                    ...
                    <div className="flex-1 max-w-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white p-6 rounded-lg">
                                ...
                                <Link href="/programs" className="text-red-600 font-medium text-sm hover:text-red-700">
                                    Browse Schools →
                                </Link>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg">
                                ...
                                <Link href="/write-review" className="text-red-600 font-medium text-sm hover:text-red-700">
                                    Write Review →
                                </Link>
                            </div>
